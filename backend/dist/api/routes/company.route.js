...
router.get('/', (0, middleware_1.auth)(['admin', 'accountant', 'dispatcher', 'driver']), controller.getCompanies); // Dispatcher added
router.get('/:id', (0, middleware_1.auth)(['admin', 'accountant', 'dispatcher', 'driver']), controller.getCompanyById);
router.get('/:id/overview', (0, middleware_1.auth)(['admin', 'accountant', 'dispatcher', 'driver']), controller.getCompanyOverview);
